...
function _ScoreboardUpdater_SetTextSafe( panel, childName, textValue )
{
	...
	var childPanel = panel.FindChild( childName );
	if ( childPanel === null ){
		return;
	}
...
//=============================================================================
//Replaces text of panel.child with textValue
//=============================================================================

function _SetText_From_String( panel, childName, textValue )
{
	if ( panel === null ){
		return;
	}
...
//=============================================================================
//=============================================================================
	function _Update_Clarity_Team_Score(blueScore, redScore)
	{
	//Hardcoding again
		_SetText_From_String( "TeamScorePanel", "TeamScoreB", blueScore );
		_SetText_From_String( "TeamScorePanel", "TeamScoreR", redScore );
	//End Hardcoding
	}
//=============================================================================
//=============================================================================
