function OnSpellStart( keys )
	...
	keys.ability:ApplyDataDrivenThinker(keys.caster, keys.ability:GetCursorPosition(), "modifier_karthus_lay_waste_thinker", {})
end
...
function OnCreated( keys )
	...
	DebugDrawCircle(keys.ability:GetCursorPosition(), Vector(0, 255, 0), 1, explosion_radius, true, explosion_delay)
end
...
function OnDestroy( keys )
	...
	DebugDrawCircle(keys.target:GetAbsOrigin(), Vector(255, 0, 0), 1, explosion_radius, true, 0.1)
